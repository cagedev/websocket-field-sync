...
if (_token) {
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        _entangled.forEach((element) => {
            ...
            _connections.push(
                element
                // NOTE If the current user may not make this new connection 
                //      (due to too many connections?) then (part of) this will fail
...
class EntangledConnection {
    ...
    constructor(server, token, roomId = 'REQUEST', options = {}) {
